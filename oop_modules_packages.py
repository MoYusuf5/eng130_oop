...
# print(os.cpu_count()) # this will result in the number of cpu - unique to the user's device
# print(datetime.date.today()) # this will result in today's date based on your OS
# print(sys.path)
...
#
#
# # let's create a function that takes int as an arg
